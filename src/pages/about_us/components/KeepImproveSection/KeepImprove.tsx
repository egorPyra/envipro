...
export default function KeepImprove() {
    return (
        <section className={styles.keepContainer}>
            ...
            <div className={styles.blockContainer}>
                ...
                <div className={styles.understand}>
                    <p>Понимая важность и значимость вопроса подготовки молодых кадров,
                        ООО «ЭнвиПро»участвует в учебном процессе и обеспечивает возможность прохождения производственных практик студентов Института наук о Земле Санкт-Петербургского государственного университета.</p>
                </div>
                <div className={styles.also}>
                    <p>
                        а также, является одним из организаторов Межрегиональной экологической полевой школы «Голубинские мела», реализуемой совместно с Молодёжным клубом Русского географического Общества и АНО «Излучина Дона» для школьников и студентов</p>
                </div>
            </div>
        </section>
    );
