...
export default function TeamSection() {
  ...
  const y4 = useTransform(scrollYProgress, [0, 1], [-1000, 1000])
  const y5 = useTransform(scrollYProgress, [0, 1], [-1300, 1300])
  const y3 = useTransform(scrollYProgress, [0, 1], [-1600, 1600])
  const y6 = useTransform(scrollYProgress, [0, 1], [-2300, 2300])
  const y2 = useTransform(scrollYProgress, [0, 1], [-2600, 2600])
  const y7 = useTransform(scrollYProgress, [0, 1], [-2800, 2800])
  const y1 = useTransform(scrollYProgress, [0, 1], [-2800, 2800])
