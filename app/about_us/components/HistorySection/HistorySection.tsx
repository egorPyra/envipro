    ...
    <section id='history' className={styles.historyContainer}>
      ...
      <div className={styles.historyContent}>
        ...
        transition={{ 
          ...
          Мы&nbsp;действительно Команда, в&nbsp;которой каждый является не&nbsp;только профессионалом своего дела, но&nbsp;и&nbsp;немного его фанатом. Уже более десяти лет мы&nbsp;оказываем различные экологические услуги во&nbsp;многих уголках нашей необъятной страны. И&nbsp;где&nbsp;бы мы&nbsp;ни&nbsp;находились, мы&nbsp;всегда получаем огромное удовольствие, решая для вас даже самые сложные задачи.
        </motion.p>
        <motion.p
         className={styles.historyText}
         initial={{ y: 100, opacity: 0 }}
         ...
         transition={{ 
          ...
          ООО &laquo;ЭнвиПро&raquo; обладает всеми необходимыми разрешительными документами, собственной химико-аналитической лабораторией, а&nbsp;также сотрудничает с&nbsp;лучшими узкопрофильными специалистами ведущих научных учреждений страны.
        </motion.p>
        <motion.p 
        className={styles.historyText}
        initial={{ y: 100, opacity: 0 }}
        ...
        transition={{ 
          ...
          Мы&nbsp;одинаково высоко ценим каждого из&nbsp;наших заказчиков и&nbsp;прилагаем все усилия, обеспечивая комфортное взаимодействие с&nbsp;нами. Благодаря такому подходу нас уже выбрали: дочерние общества ПАО &laquo;Газпром&raquo;, ПАО &laquo;Транснефть&raquo;, АО&nbsp;&laquo;Объединённая Энергостроительная корпорация&raquo;, ЗАО &laquo;Нортгаз&raquo;, АО&nbsp;&laquo;Гипротрубопровод&raquo;, ООО &laquo;Роза Хутор&raquo;, НАО &laquo;Красная Поляна&raquo;, ООО &laquo;ЭльгаТранс&raquo;, ООО &laquo;Еврохим терминал Усть-Луга&raquo;, АО&nbsp;&laquo;Росинжиниринг&raquo;, ФГБУ &laquo;Институт Карпинского&raquo; и&nbsp;многие другие
        </motion.p>
        <motion.p 
        className={styles.historyText}
        initial={{ y: 100, opacity: 0 }}
